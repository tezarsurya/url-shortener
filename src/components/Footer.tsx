  ...
  return (
    <footer className="grid w-full place-items-center gap-y-10 bg-[#35323e] px-6 py-16 md:grid-cols-10 md:items-start md:gap-x-4 lg:px-28 xl:grid-cols-12 xl:px-40">
      ...
      <FooterLinkContainer title="Features">
        <FooterLink href="#" text="Link Shortening" />
        <FooterLink href="#" text="Branded Links" />
        <FooterLink href="#" text="Analytics" />
      </FooterLinkContainer>
      <FooterLinkContainer title="Resources">
        <FooterLink href="#" text="Blog" />
        <FooterLink href="#" text="Developers" />
        <FooterLink href="#" text="Support" />
      </FooterLinkContainer>
      <FooterLinkContainer title="Company">
        <FooterLink href="#" text="About" />
        <FooterLink href="#" text="Our Team" />
      ...
      <div className="grid w-fit grid-flow-col place-items-center gap-x-6 md:col-span-2 md:gap-x-2">
        <svg
          ...
          width="24"
          height="24"
          className="btn fill-white hover:fill-[#2acfcf]"
        >
